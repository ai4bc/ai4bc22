...
<div class="content list people">
    ...
    <div class="list-item-people">
        <p class="list-post-title">
            <img class="profile-thumbnail" src="https://www.heinz.cmu.edu/faculty-research/profiles/ghani-rayid/_files/rayidghani-bio.jpg"/>
...
<div class="content list people">
    ...
    <div class="list-item-people">
        <p class="list-post-title">
            ...
            <span class="caption"><a href="https://www.jennlogg.com/">Jennifer Logg</a><br>Management<br>Georgetown University</span>
        </p>
    </div>
    <div class="list-item-people">
        <p class="list-post-title">
